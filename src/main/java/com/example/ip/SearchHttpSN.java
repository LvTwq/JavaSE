...
public class SearchHttpSN {
    ...
    public static String AK = "9LW1svPreKk2kELVqGE7Ei6k7y0bYDrq";

    public static String SK = "ROf0hm6Y4uoVPzlcTkpC9NxGhDaBDavT";
